...
Original file is located at
    https://colab.research.google.com/drive/1xMmCFiXBbh0zZhsUdSmMGD2z9-V5OmJr
"""
...
def calculate_refined_scores(filename, body_weight=700, window_size=0.2):
    ...
    # Symmetry Calculation (remains the same)
...
# Example Usage
filename = 'treadmill_trial_refined.xlsx'
refined_scores = calculate_refined_scores(filename)
print(f"Fatigue Score (Right): {refined_scores['Right_Fatigue']:.2f}")
print(f"Fatigue Score (Left): {refined_scores['Left_Fatigue']:.2f}")
print(f"Stress Score: {refined_scores['Stress_Score']:.2f}")
print(f"Symmetry Score: {refined_scores['Symmetry_Score']:.2f}")